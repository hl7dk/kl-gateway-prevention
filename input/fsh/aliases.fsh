...
Alias: $KLCommonCodes = http://kl.dk/fhir/common/caresocial/CodeSystem/KLCommonCareSocialCodes //http://fhir.kl.dk/term/CodeSystem/CommonCareSocialCodes
Alias: $KLConditionCodes119 = http://kl.dk/fhir/common/caresocial/ValueSet/KLConditionCodesPrevention // http://fhir.kl.dk/term/ValueSet/http://kl.dk/fhir/common/caresocial/ValueSet/KLConditionCodesPrevention
